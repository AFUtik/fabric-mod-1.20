...
import org.mynewmod.block.custom.FurnaceBlock;
...
public class ModBlocks  {
    ...
    public static Block FURNACE_BLOCK = registerBlock("furnace_block", new FurnaceBlock(FabricBlockSettings.create().strength(4.0f)), ModItemsGroups.NEW_GROUP);
